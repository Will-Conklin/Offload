...
**Offload** is an iOS app that reduces mental overload by allowing users to quickly capture thoughts and optionally organize them with AI. The app prioritizes **externalizing first**, **organizing later**, and **never forcing structure**.
